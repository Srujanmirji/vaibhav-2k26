...
const DEFAULT_KEYWORDS =
  'Vaibhav 2K26, JCET, JCET Hubballi, JCET Hubli, Jain College of Engineering and Technology, Jain College Hubballi, tech fest, cultural fest, college events';
...
const PAGE_METADATA: Record<string, PageMeta> = {
  '/': {
    title: 'Vaibhav 2K26 | JCET Hubballi Official Cultural & Tech Fest Website',
    description:
